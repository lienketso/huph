...
@section('content')
    ...
    <ol class="breadcrumb breadcrumb-quirk">
        ...
        <li class="active">Thêm lịch sử hình thành</li>
    </ol>
            ...
            <div class="col-sm-8">
                <div class="panel">
                    <div class="panel-heading">
                        <h4 class="panel-title">Thêm lịch sử hình thành</h4>
                        <p>Bạn cần nhập đầy đủ các thông tin để thêm lịch sử hình thành mới</p>
                    </div>
