...
@section('content')
    ...
    <ol class="breadcrumb breadcrumb-quirk">
        ...
        <li class="active">Thêm nhóm chủ trị</li>
    </ol>
            ...
            <div class="col-sm-8">
                <div class="panel">
                    <div class="panel-heading">
                        <h4 class="panel-title">Thêm nhóm chủ trị</h4>
                        <p>Bạn cần nhập đầy đủ các thông tin để thêm nhóm chủ trị mới</p>
                    </div>
