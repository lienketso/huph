                        ...
                        <div class="panel-form-khac" style="padding-top: 20px">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-xs-6">
                                    ...
                                    <div class="form-group">
                                        <input class="form-control"
                                               name="form_key_30_{{$language}}"
                                               type="text"
                                               value="{{$setting->getSettingMeta('form_key_30_'.$language)}}"
                                               placeholder="Tên cây thuốc">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-3 col-xs-6">
                                    ...
                                    <div class="form-group">
                                        <input class="form-control"
                                               name="form_key_31_{{$language}}"
                                               type="text"
                                               value="{{$setting->getSettingMeta('form_key_31_'.$language)}}"
                                               placeholder="Động vật làm thuốc">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-3 col-xs-6">
                                    ...
                                    <div class="form-group">
                                        <input class="form-control"
                                               name="form_key_32_{{$language}}"
                                               type="text"
                                               value="{{$setting->getSettingMeta('form_key_32_'.$language)}}"
                                ...
                                <div class="col-lg-3 col-xs-6">
                                    ...
                                    <div class="form-group">
                                        <input class="form-control"
                                               name="form_key_33_{{$language}}"
                                               type="text"
                                               value="{{$setting->getSettingMeta('form_key_33_'.$language)}}"
                                ...
                                <div class="col-lg-3 col-xs-6">
                                    ...
                                    <div class="form-group">
                                        <input class="form-control"
                                               name="form_key_34_{{$language}}"
                                               type="text"
                                               value="{{$setting->getSettingMeta('form_key_34_'.$language)}}"
