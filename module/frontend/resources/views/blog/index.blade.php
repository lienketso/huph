                   ...
                   success: function(data) {
                       ...
                       if (data.data.length > 0) {
                           ...
                           for (var i = 0; i < data.data.length; i++) {
                               ...
                               html += '<div class="col-md-3"><div class="card"><div class="border-img"><div class="border-tag"><span class="badge rounded-pill text-bg-tag">Bài báo</span><span class="badge rounded-pill text-bg-tag">Phục gồi chức năng</span></div><a href="'+link+'"><img src="'+imgUrl+'" class="card-img-top" alt="" /></a></div><div  class="card-body"><h5 class="card-title">'+ data.data[i].name + '</h5><h6 class="card-subtitle mb-2 text-body-secondary">by <strong>Dung Nguyen</strong> - ngày 20 tháng 04 năm 2024</h6><p>'+ data.data[i].description + '</p></div></div></div>';
                           }
