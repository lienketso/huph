...
@section('content')
    ...
    <ol class="breadcrumb breadcrumb-quirk">
        ...
        <li><a href="{{route('wadmin::cat-addmission.index.get')}}">Danh mục tuyển sinh</a></li>
        <li class="active">Sửa danh mục tuyển sinh "<strong>{{$data->name}}</strong>>"</li>
    </ol>
        ...
        <form method="post" enctype="multipart/form-data">
            ...
            <div class="col-sm-8">
                <div class="panel">
                    <div class="panel-heading">
                        <h4 class="panel-title">Sửa danh mục tuyển sinh</h4>
            ...
            <div class="col-sm-4">
                <div class="panel">
                    ...
                    <div class="panel-body">
                        <input type="hidden" name="cat_type" value="tuyensinh">
                        <div class="form-group">
                            <label>Danh mục cha</label>
                            <select id="" name="parent" class="form-control" style="width: 100%" data-placeholder="">
                                <option value="0">--Là danh mục cha--</option>
                                {{$model->optionCategoryTS(0,1,4,$data->parent,$data->id,'tuyensinh')}}
                            </select>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-xs-12" style="display: flex">
                                <input type="text" name="thumbnail"
                                       value="{{$data->thumbnail}}" id="ckfinder-input-1" class="form-control file-upload-info" placeholder="Upload Image">
                        ...
                        <div class="form-group">
                            <label>Ảnh banner danh mục ( Nếu có )</label>
                            <div class="input-group col-xs-12" style="display: flex">
