<div class="form-group">
    <label>Tên động vật làm thuốc</label>
    <div class="row">
        <div class="col-lg-4">
            <input class="form-control"
                   name="meta[meta_animal_text][title]"
                   type="text"
                   value="{{($postModel->getPostMetaJson('meta_animal_text','title',$data->id)=='null')) ? $setting->getSettingMeta('form_key_31_'.$lang) : $postModel->getPostMetaJson('meta_animal_text','title',$data->id}}"
                   placeholder="Tiêu đề trường (hiển thị ở trường search)">
        </div>
        <div class="col-lg-8">
            <input class="form-control"
                   name="meta[meta_animal_text][name]"
                   type="text"
                   value="{{old('meta_animal_text',$postModel->getPostMetaJson('meta_animal_text','name',$data->id))}}"
