...
<div class="form-group">
    <label>Tên vị thuốc</label>
    <div class="row">
        <div class="col-lg-4">
            <input class="form-control"
                   name="meta[meta_taste_text][title]"
                   type="text"
                   value="{{($postModel->getPostMetaJson('meta_taste_text','title',$data->id)=='null')) ? $setting->getSettingMeta('form_key_33_'.$lang)  : $postModel->getPostMetaJson('meta_taste_text','title',$data->id}}"
                   placeholder="Tiêu đề trường (hiển thị ở trường search)">
        </div>
        <div class="col-lg-8">
            <input class="form-control"
                   name="meta[meta_taste_text][name]"
                   type="text"
                   value="{{old('meta_taste_text',$postModel->getPostMetaJson('meta_taste_text','name',$data->id))}}"
