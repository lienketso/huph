...
@section('content')
    ...
    <ol class="breadcrumb breadcrumb-quirk">
        ...
        <li><a href="{{route('wadmin::comment.index.get')}}">cảm nhận học viên</a></li>
            ...
            <div class="col-sm-8">
                <div class="panel">
                    <div class="panel-heading">
                        <h4 class="panel-title">Thêm cảm nhận học viên</h4>
                        <p>Bạn cần nhập đầy đủ các thông tin để thêm cảm nhận học viên mới</p>
                    </div>
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            <label>Mô tả</label>
                            <input type="text" id="" name="description" value="{{old('description')}}" class="form-control" placeholder="Mô tả ngắn">
                        </div>
                        <div class="form-group">
